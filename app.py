...
# ---------------------------------------------------------
# SIDEBAR INPUTS (ALL RESET TO ZERO/BLANK)
# ---------------------------------------------------------
with st.sidebar:
    ...
    fridge = st.toggle(
        "Backup the fridge?",
        value=False,
        help="This estimates the power needed to keep your fridge cold during an outage."
    )
...
# Only calculate if people > 0 to avoid errors
if people > 0:
